...
window.NAV_SECTIONS = [
  {
    ...
    status: "active",
    topics: [
      { name: "Home", url: "on-call-essentials.html", tag: "" },
  ...
  },
  {
    ...
    status: "active",
    topics: [
      { name: "Status Epilepticus", url: "epilepsy.html#algo1", tag: "STAT" },
      { name: "First Seizure", url: "epilepsy.html#algo2", tag: "" },
      { name: "Provoked Seizure", url: "epilepsy.html#algo3", tag: "" },
      { name: "Unprovoked Seizure", url: "epilepsy.html#algo4", tag: "" },
      { name: "Seizure Mimics", url: "epilepsy.html#ch-mimics", tag: "" }
    ]
  },
  {
    name: "Stroke",
  ...
  { name: "Neuromuscular", icon: "\uD83D\uDCAA", status: "planned", topics: [] },
  {
    ...
    status: "active",
    topics: [
      { name: "Algorithm 1 — Emergency", url: "headache.html#algo1", tag: "STAT" },
      { name: "Algorithm 2 — High-Risk", url: "headache.html#algo2", tag: "" },
      { name: "Phenotype the Headache", url: "headache.html#ch-phenotype", tag: "" },
      { name: "Secondary Headache: Clue → Cause", url: "headache.html#ch-secondary", tag: "" },
      { name: "30-Second Recap", url: "headache.html#ch-recap", tag: "" }
    ]
  },
